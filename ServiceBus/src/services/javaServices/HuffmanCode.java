...
public class HuffmanCode {
    ...
    ArrayList<ArrayList<Object>> occuranceNumber = new ArrayList<>();
    ...
    public ArrayList<ArrayList<Object>> separateCharsInString(String text)
    {
            char[] charLine;
            int index;
            ArrayList<Object> character = new ArrayList<Object>();
    ...
    public String[] normalConvertedText(String text)
    {
        String file = "";
        String[] fileBits = new String[2];
        int bits = 0;
    ...
    public String[] printConvertedText(String text,ArrayList<Object> table)
    {
        String file = "";
        String[] fileBits = new String[2];
        int bits = 0 , newLineLength = 0;
    ...
    */
    ...
    public static String run(String text){
        ...
        ArrayList<ArrayList<Object>> occurances;
        HuffmanCode h1 = new HuffmanCode();
        occurances = h1.separateCharsInString(text);
        ArrayList<Object> chars = occurances.get(0);
        ArrayList<Object> values = occurances.get(1);
        ...
        String output = "";
        output += "Frequency  \t  Character  \t     Code\n";	          
        int ln = table.size();
        for(int i = 0; i < ln; i += 2)
        {
            ...
            if (tmpC == newLine)
            {
                    output += "    " + h1.originalOcurences.get(index) + "     =====     \\n      ====>    ";
            }
            else if (tmpC == space)
            {
                    output += "   " + h1.originalOcurences.get(index) + "     =====    space    ====>    ";
            }
            else	
            {
                    output += "    " + h1.originalOcurences.get(index) + "     =====      " + table.get(i) + "      ====>    ";

            }
            output += table.get(i+1) + "\n";
        }		
        ...
        output += "\n# Original text: \n";
        output +=  "'"+text+"'";
        output += "\n\n# Converted text (Fixed length - 8bits per character): \n";
        String[] normalBits = h1.normalConvertedText(text);
        output += "# " + normalBits[0] + " bits  \n";
        output += normalBits[1];
        output += "\n\n# Converted text (Huffman Code): \n";
        String[] huffmanBits = h1.printConvertedText(text,table);
        output += "# " + huffmanBits[0] + " bits  \n";
        output += huffmanBits[1];
